...
Resolução :
Criar um novo pacote Node.js, conforme vimos na aula passada;
Criar os dois arquivos que serão lidos. O conteúdo pode ser extraído de um gerador de lorem-ipsum. Chamaremos os arquivos de file1.txt e file2.txt ;
Criar, na mesma pasta, o script que realizará a leitura do arquivo, que deve ficar parecido com o seguinte script:
...
Resolução :
Criar um novo pacote Node.js;
Criar uma pasta com alguns arquivos dentro (pode ser a mesma pasta do exercício anterior);
Criar o script com um resultado final parecido com esse:
