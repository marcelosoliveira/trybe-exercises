...
module.exports = async (req, res) => {
  ...
  password = bcrypt.compareSync(req.body.password, user.password)

  if (!user || !password) return res.status(401).json({ message: 'Usuário não existe ou senha inválida' });
