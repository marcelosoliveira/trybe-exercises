...
# conteúdo, para que ela suporte um limite de itens dentro da pilha. Se definirmos
# que a pilha deve ter o tamanho dois, ela não poderá ter três itens. Por exemplo:
# stack_limit.py
