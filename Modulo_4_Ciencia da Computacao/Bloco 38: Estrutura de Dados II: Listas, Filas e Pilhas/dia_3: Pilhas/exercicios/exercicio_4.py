# ercício 4: Dada a função que faz a resolução de expressões pós fixas, adicione as 
# operações de subtração e divisão. Considere os exemplos abaixo para testar a sua 
# alteração na função.
# Nota: transforme as expressões em pós fixas e atribua valores. Caso seja necessário,
# faça o cast do valor para ponto flutuante.
