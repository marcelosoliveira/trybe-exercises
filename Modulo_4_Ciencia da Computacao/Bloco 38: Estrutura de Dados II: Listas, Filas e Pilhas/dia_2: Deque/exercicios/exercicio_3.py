# Exercício 3: Desafio do Palíndromo - Uma palavra é um palíndromo se a sequência de
...
# ou não um palíndromo. Para este exercício iremos considerar todas os caracteres 
# como minúsculos e desconsiderar espaços, pontuação e caracteres especiais.

# Use a tabela a seguir como exemplo para seus testes:

# Tabela exercício 3.
# Para esse desafio a maior preocupação é na inserção dos dados, pois não devem ser
# considerados caracteres especiais e espaços. Assim como tornar todos os 
