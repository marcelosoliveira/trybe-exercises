# Exercício 1: Aprimorando a classe Lista : nossa classe Lista atende as principais
# operações que essa TAD nos oferece, mas que tal melhorarmos? Para isso, você deve 
...
# 1 - b. __get_node_at(self, position) - Para este desafio foi realizado a extração
# do trecho de código mais repetitivo, que estava sendo utilizado nos demais métodos.
# Vale salientar que nos casos que precisamos do anterior ao ultimo, precisamos fazer
# a operação len(self) - 2 .
