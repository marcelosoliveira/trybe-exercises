# Exercício 2: Nova busca : até o momento nossa estrutura consulta elementos através
...
# Nesta atividade é necessário percorrer toda a lista. As condições de parada são a 
# existência do valor ou ter percorrido toda a lista sem sucesso. O valor é retornado
# caso encontrado e -1 caso contrário.
