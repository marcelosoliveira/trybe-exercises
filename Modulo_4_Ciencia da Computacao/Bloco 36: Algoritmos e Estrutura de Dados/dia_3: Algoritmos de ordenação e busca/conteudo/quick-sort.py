...
# complexidade O(n²) .
# Curiosidade: Por baixo dos panos, quando você utiliza a função sorted 
# padrão do python ou faz array.sort , você está utilizando uma ordenação 
# chamada TimSort , que é um algoritmo híbrido que mistura o merge sort e 
# insertion sort. É também utilizado pela linguagem Java para ordenar arrays.