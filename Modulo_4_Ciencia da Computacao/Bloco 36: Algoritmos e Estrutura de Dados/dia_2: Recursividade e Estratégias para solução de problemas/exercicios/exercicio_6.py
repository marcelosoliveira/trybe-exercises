""" Exercício 6: Escreva um algoritmo recursivo que resolva o problema da torre de
hanoi, seguindo as instruções:
Assim como na imagem abaixo, a torre deve conter 3 discos, e três colunas;
Os discos começam alinhados na primeira coluna, e devem ser organizados respeitando
a ordem de tamanho, na última coluna.
