# Exercício 1 - Blefe
# Blefe é um jogo de duas pessoas onde cada uma tenta adivinhar os número que a outra 
# irá escolher. Cada jogador escolhe 5 números de 0 a 10, inclusive. A pontuação 
# final é calculada da seguinte forma:
...
# Implemente uma função que receba um dicionário com os nomes e números chutados e 
# retorne o nome de quem ganhou.
