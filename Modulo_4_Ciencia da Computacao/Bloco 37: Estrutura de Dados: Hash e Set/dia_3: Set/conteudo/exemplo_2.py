...
# precisamos que a nossa classe tenha um método chamado __str__ e é o que faremos 
# agora:
...
# A saída não precisa ser ordenada, até mesmo porque um conjunto não leva a ordem 
# em consideração. A saída pode ser em qualquer ordem, mas provavelmente será mais 
# fácil retornar em ordem. Teste seu método imprimindo os objetos que você criou.
