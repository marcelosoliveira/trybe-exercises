...
# precisamos saber qual o tempo máximo que um software permaneceu sem instabilidades.
# Para isto, a cada hora é feito uma requisição ao sistema e verificamos se está ok.
# Supondo um array que contenha os estados coletados por nosso software, calcule
